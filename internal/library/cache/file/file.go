...
var CacheExpiredErr = errors.New("cache expired")
...
func (c *AdapterFile) Set(ctx context.Context, key, value interface{}, lifeTime time.Duration) (err error) {
...
func (c *AdapterFile) SetIfNotExist(ctx context.Context, key, value interface{}, duration time.Duration) (ok bool, err error) {
...
func (c *AdapterFile) GetOrSet(ctx context.Context, key, value interface{}, duration time.Duration) (result *gvar.Var, err error) {
...
func (c *AdapterFile) Update(ctx context.Context, key, value interface{}) (oldValue *gvar.Var, exist bool, err error) {
...
func (c *AdapterFile) Save(key, value string, lifeTime time.Duration) error {
	duration := int64(0)
